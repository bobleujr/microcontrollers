...
increment:
	...
	cjne r1, #100, increment	;If register 1 is not equal to 100 small jump to increment lable
decrement:	
	dec r1						;Decrement register 1 by 1
	cjne r1, #0, decrement		;If register 1 is not equal to 0 small jump to decrement lable
